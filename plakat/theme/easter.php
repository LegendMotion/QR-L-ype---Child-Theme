...
<style>
.sheet {
    background: url(https://plakat.qrloype.no/background/easter.jpeg) !important;
...
switch ($favlogo) {
  case "ja":
    ...
    break;
  case "nei":
    require 'assets/logo_forandringshuset.php';
    break;
  default:
    require 'assets/logo_forandsringshuset.php';
}
